...
//        return (Object[]) ((Object[]) removeAll((Object) array, clone(indices)));
//    }
    ...
    private static int[] extractIndices(HashSet<Integer> coll) {
        ...
        Integer index;
        for (Iterator i$ = coll.iterator(); i$.hasNext(); result[i++] = index.intValue()) {
    ...
    public static <T> List<T> asReadOnlyList(T... array) {
        return new ArrayUtils.ReadOnlyArrayList(array);
    }
...
//                    contents = (Object[]) ((Object[]) Array.newInstance(ct, size));
//                }
//
